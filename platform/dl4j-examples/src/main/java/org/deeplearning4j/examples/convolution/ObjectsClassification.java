...
public class ObjectsClassification {
    ...
    protected static String modelType = "custom";
    ...
    public void run(String[] args) throws Exception {
        ...
        File mainPath = new File("/Users/bater.makhabel/WorkSpace/WritingBox/VideoCoursesWriting/Writing/GitHub/Deep-Learning-with-Apache-Spark/platform/", "dl4j-examples/src/main/resources/objects/");
...
//        MultiLayerNetwork network = new AlexNet(height, width, channels, numLabels, seed, iterations).init();
        ...
        log.info("****************Deep Learning with Apache Spark, Section 7, Object Recognition Example finished********************");
    }
