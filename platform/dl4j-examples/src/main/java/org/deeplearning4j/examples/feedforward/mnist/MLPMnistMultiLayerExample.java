...
*
*/
public class MLPMnistMultiLayerExample {

    private static Logger log = LoggerFactory.getLogger(MLPMnistMultiLayerExample.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        double rate = 0.005; // learning rate
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
            ...
            .layer(5, new DenseLayer.Builder()
                    ...
                    .nOut(100)
                    .build())
            .layer(6, new OutputLayer.Builder(LossFunction.NEGATIVELOGLIKELIHOOD) //create hidden layer
